...
RPQuestionStep q2 = RPQuestionStep(identifier: "EMA Question 2", title: "2. Where are you now (Check all that apply)?", answerFormat: answerFormat2);
RPAnswerFormat answerFormat2 = RPChoiceAnswerFormat(answerStyle: RPChoiceAnswerStyle.MultipleChoice, choices: [RPChoice(text: "Your home", value: 0),RPChoice(text: "Relative’s home", value: 1),RPChoice(text: "Friend’s home", value: 2),RPChoice(text: "School", value: 3),RPChoice(text: "Work", value: 4),RPChoice(text: "In car", value: 5),RPChoice(text: "Other transit", value: 6)]);

RPQuestionStep q3 = RPQuestionStep(identifier: "EMA Question 3", title: "3. Are you with other people? (check all that apply)", answerFormat: answerFormat3);
RPAnswerFormat answerFormat3 = RPChoiceAnswerFormat(answerStyle: RPChoiceAnswerStyle.MultipleChoice, choices: [RPChoice(text: "Alone", value: 0),RPChoice(text: "With people I don't know", value: 1),RPChoice(text: "With people I know", value: 2)]);

RPQuestionStep q4 = RPQuestionStep(identifier: "EMA Question 4", title: "4. In the few minutes before completing this survey, were you...", answerFormat: answerFormat4);
RPAnswerFormat answerFormat4 = RPChoiceAnswerFormat(answerStyle: RPChoiceAnswerStyle.SingleChoice, choices: [RPChoice(text: "standing", value: 0),RPChoice(text: "TV/sitting walking lying down", value: 1)]);

RPQuestionStep q5 = RPQuestionStep(identifier: "EMA Question 5", title: "5. Since the past 4 hours, have you consumed(check all that apply)", answerFormat: answerFormat5);
RPAnswerFormat answerFormat5 = RPChoiceAnswerFormat(answerStyle: RPChoiceAnswerStyle.MultipleChoice, choices: [RPChoice(text: "Food", value: 0),RPChoice(text: "Marijuana", value: 1),RPChoice(text: "Water", value: 2),RPChoice(text: "Tobacco ", value: 3)]);

RPQuestionStep q6 = RPQuestionStep(identifier: "EMA Question 6", title: "6. Since the past 4 hours, how much alcohol did you consume?", answerFormat: answerFormat6);
RPAnswerFormat answerFormat6 = RPChoiceAnswerFormat(answerStyle: RPChoiceAnswerStyle.SingleChoice, choices: [RPChoice(text: "None", value: 0),RPChoice(text: "Less than 1 drink 1 drink", value: 1),RPChoice(text: "2 drinks", value: 2),RPChoice(text: "3 drinks", value: 3),RPChoice(text: "4 drinks", value: 4),RPChoice(text: "5 drinks", value: 5),RPChoice(text: "6 or more drinks", value: 6)]);
